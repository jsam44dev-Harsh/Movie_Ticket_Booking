...
const TheaterListsByCinema = ({ cinemas, selectedCinemaIndex, setSelectedCinemaIndex, fetchCinemas, auth }) => {
	...
	return (
		<div className=" mx-4 h-fit rounded-md bg-black text-white border-solid border-2 drop-shadow-md sm:mx-8">
						...
						{isEditing ? (
							<form onClick={handleSubmitName(onEditCinema)}>
								<button
									...
									className="flex w-fit items-center gap-1 rounded-md bg-black  py-1 pl-2 pr-1.5 text-sm font-medium text-white"
									onClick={() => {
										SetIsEditing(false)
									}}
								>
							...
							<button
								...
								className="flex w-fit items-center gap-1 rounded-md bg-[#5C8374]  py-1 pl-2 pr-1.5 text-sm font-medium text-white hover:from-indigo-500 hover:to-blue-400"
			...
			<div className="flex flex-col gap-6 p-4 sm:p-6 overflow-y-auto">
				...
				<form className="flex flex-col gap-4" onSubmit={handleSubmit(onIncreaseTheater)}>
					...
					{auth.role === 'admin' && (
						<div className=" border-solid border-2 border-[#344955] flex w-full flex-wrap justify-between gap-4 rounded-md bg-black p-4">
							...
							<div className="flex grow flex-col gap-4 sm:justify-end md:flex-row">
								<div className="flex flex-wrap justify-end gap-4">
									<div className="flex flex-wrap gap-2">
										...
										<input
											...
											maxLength="2"
											required
											className={`bg-gray-500 w-14 rounded px-3 py-1 text-2xl font-semibold drop-shadow-sm leading-3
									...
									<div className="flex flex-wrap gap-2">
										...
										<input
											...
											maxLength="3"
											required
											className={`bg-gray-500 w-24 rounded px-3 py-1 text-2xl font-semibold drop-shadow-sm leading-3 ${
								...
								<div className="flex grow md:grow-0 ">
									<div className="flex flex-col items-center justify-center gap-1 rounded-l bg-gray-500 p-1 text-white">
									...
									<button
										...
										className="flex grow items-center justify-center whitespace-nowrap rounded-r bg-[#5C8374] px-2 py-1 font-medium text-white drop-shadow-md hover:from-indigo-500 hover:to-blue-400 disabled:from-slate-500 disabled:to-slate-400 md:grow-0"
										type="submit"
									>
