	...
	return (
		<>
			...
			<div className=" flex justify-between ">
				<div className="flex flex-col justify-center rounded-tl-lg bg-[#0c3441] px-4 py-0.5 text-center font-bold text-white sm:px-8">
					<p className="text-sm ">Theater</p>
					<p className="text-3xl ">{showtime?.theater?.number}</p>
				</div>
				<div className="flex w-fit grow items-center justify-center rounded-tr-lg bg-[#538392] px-4 py-0.5 text-center text-xl font-bold text-white sm:text-3xl">
			...
			<div className="flex flex-col md:flex-row">
				<div className="flex grow flex-col gap-4 bg-[#ebd9c5] py-2 drop-shadow-lg sm:py-4">
				...
				<div className="flex flex-col">
					<div className="flex h-full min-w-max flex-col items-center justify-center gap-y-1 bg-[#C6EBC5] py-2 text-center text-xl font-semibold drop-shadow-lg sm:py-4 sm:text-2xl md:items-start">
