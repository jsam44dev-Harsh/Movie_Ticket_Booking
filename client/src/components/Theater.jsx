		...
		<div className="flex flex-col">
			<div className="flex md:justify-between">
				...
				>
					...
					{auth.role === 'admin' && (
					<div className="flex w-fit flex-col gap-x-3 rounded-tr-2xl bg-[#5C8374] px-4 py-0.5 font-semibold text-white md:flex-row md:gap-x-6 md:rounded-t-2xl md:text-lg md:font-bold">
			...
			<div className="flex flex-col gap-4 rounded-b-md rounded-tr-md bg-black border-solid border-2 border-[#344955] py-4 md:rounded-tr-none ">
				{auth.role === 'admin' && (
					<>
						<form
							className="mx-4 p-2 flex flex-col gap-x-4 gap-y-2 lg:flex-row border-solid border-2 border-[#344955]"
							...
							<div className="flex  grow flex-col gap-2 rounded-lg">
								...
								<div className="flex flex-col gap-2 rounded-lg lg:flex-row lg:items-stretch">
									...
									<label className="flex items-center gap-x-2 gap-y-1 whitespace-nowrap text-lg font-semibold leading-5 lg:flex-col lg:items-start">
										...
										<input
											type="checkbox"
											className="h-6 w-6 lg:h-9 lg:w-9 bg-gray-500"
											{...register('isRelease')}
										/>
									</label>
									...
									>
										...
										<input
											type="time"
											className="h-9 w-full rounded bg-gray-500 px-2 py-1 font-semibold text-gray-900 drop-shadow-sm disabled:bg-gray-300"
											disabled={!watch('autoIncrease')}
											{...register('gap')}
										/>
									</div>
