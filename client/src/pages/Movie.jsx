...
const Movie = () => {
	...
	return (
		<div className="flex min-h-screen flex-col gap-4 bg-gradient-to-br from-indigo-900 to-blue-500 pb-8 text-gray-900 sm:gap-8"
			...
			<Navbar />
			<div className="border-solid border-2 border-green-900 mx-4 flex h-fit flex-col gap-4 rounded-md bg-black  p-4 drop-shadow-xl sm:mx-8 sm:p-6">
				<h2 className="text-3xl font-bold text-white flex justify-center">Movie Lists</h2>
				<form
					onSubmit={handleSubmit(onAddMovie)}
					className="bg-black flex flex-col justify-content-start items-stretch gap-x-4 gap-y-2 rounded-md text-white border-green-900 border-solid border-2 p-4 drop-shadow-md lg:flex-row"
				>

					<div className="bg-[#5C8374] p-3 rounded-md flex w-full grow flex-col flex-wrap justify-start gap-4 lg:w-auto">
						<h3 className="text-xl  font-bold flex justify-center">Add Movie</h3>
						<div className="flex justify-start  flex-col items-start gap-2 sm:flex-row sm:items-center">
							<label className="text-lg font-semibold leading-5">Name :</label>
							<input
								type="text"
								required
								className="w-full flex-grow rounded px-3 py-1 font-semibold drop-shadow-sm sm:w-auto text-black"
								{...register('name', {
									required: true
								})}
							/>
					...
					<div className="flex w-full flex-col gap-4 lg:w-auto lg:flex-row">
						...
						<button
							className="w-full min-w-fit items-center rounded-md bg-[#5C8374]  px-2 py-1 text-center font-medium text-white drop-shadow-md hover:from-indigo-500 hover:to-blue-500 disabled:from-slate-500 disabled:to-slate-400 lg:w-24 xl:w-32 xl:text-xl"
							type="submit"
