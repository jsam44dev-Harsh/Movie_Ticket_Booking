...
const Login = () => {
	...
	return (
		...
		<div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-indigo-900 to-blue-500 py-12 px-4 sm:px-6 lg:px-8 bg-no-repeat bg-cover" style={{backgroundImage: `url(${login})`}}>
			<div className="w-full max-w-md space-y-8 rounded-2xl bg-[#5C8374] p-4 shadow-xl border-solid border-2 border-red-800 flex-col">
				<div>
				...
				<form className="mt-8 space-y-4" onSubmit={handleSubmit(onSubmit)}>
					...
					<div>
						...
						<button
							type="submit"
							className="mt-4 w-full rounded-md bg-black py-2 px-4 font-medium text-white drop-shadow-md bg-gradient-to-br from-red-600  focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:from-slate-500 disabled:to-slate-400"
