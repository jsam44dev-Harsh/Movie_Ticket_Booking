...
const Showtime = () => {
	...
	return (
		...
		style={{
			...
			<Navbar />
			<div className="mx-4 h-fit rounded-lg bg-black border-solid border-2 border-green-900 p-4 drop-shadow-xl sm:mx-8 sm:p-6">
				{showtime.showtime ? (
					<>
						<ShowtimeDetails showtime={showtime} showDeleteBtn={true} fetchShowtime={fetchShowtime} />
						<div className="flex flex-col justify-between rounded-b-lg bg-[#538392] text-center text-lg drop-shadow-lg md:flex-row">
							...
							{!!selectedSeats.length && (
								<Link
									...
									className="flex items-center justify-center gap-2 rounded-b-lg bg-[#0c343f] px-4 py-1 font-semibold text-white hover:from-indigo-500 hover:to-blue-500 md:rounded-none md:rounded-br-lg"
								>
									<p>Purchase</p>
						...
						<div className="mx-auto mt-4 flex flex-col items-center rounded-lg bg-[#5C8374] p-4 text-center drop-shadow-lg border-solid border-2 border-green-900">
