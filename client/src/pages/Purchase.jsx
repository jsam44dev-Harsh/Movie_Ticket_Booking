	...
	return (
		<div className="flex min-h-screen flex-col gap-4 bg-gradient-to-br from-indigo-900 to-blue-500 pb-8 sm:gap-8">
			...
			<div className="mx-4 h-fit rounded-lg bg-gradient-to-br from-indigo-200 to-blue-100 p-4 drop-shadow-xl sm:mx-8 sm:p-6">
				...
				<div className="flex flex-col justify-between rounded-b-lg bg-[#6295A2] text-center text-lg drop-shadow-lg md:flex-row">
					...
					{!!selectedSeats.length && (
						<button
							onClick={() => onPurchase()}
							className="flex items-center justify-center gap-2 rounded-b-lg bg-[#0c343f] px-4 py-1 font-semibold text-white  disabled:from-slate-500 disabled:to-slate-400 md:rounded-none md:rounded-br-lg"
