...
const Tickets = () => {
	...
	return (
		<div className="flex min-h-screen flex-col gap-4 bg-gradient-to-br from-indigo-900 to-blue-500 pb-8 text-gray-900 sm:gap-8" style={{
			...
			<div className=" border-solid border-2 border-green-900 mx-4 flex h-fit flex-col gap-4 rounded-md bg-black p-4 drop-shadow-xl sm:mx-8 sm:p-6">
				<h2 className="text-3xl font-bold text-white flex justify-center">My Tickets</h2>
				{isFetchingticketsDone ? (
					<>
						{tickets.length === 0 ? (
							<p className="text-center text-white">You have not purchased any tickets yet</p>
						) : (
								...
								{tickets.map((ticket, index) => {
									return (
										<div className="flex flex-col" key={index}>
											...
											<div className="flex h-full flex-col justify-between rounded-b-lg bg-[#6295A2]   text-center text-lg drop-shadow-lg md:flex-row">
